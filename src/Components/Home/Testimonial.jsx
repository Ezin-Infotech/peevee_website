        ...
        <div className='mx-auto py-20 px-8'>
            ...
            <div className='md:gap-5 lg:flex lg:gap-8 xl:w-2/3 xl:m-auto'>
                ...
                <div className='w-full my-8 lg:my-0 lg:w-1/3'>
                    <p className='text-gray-500 italic'>“Our relationship with PEEVEE dates back to 2007 and we’ve never looked back since. The family-like culture and understanding has given us a lot to depend on and will continue to do so.”</p>
